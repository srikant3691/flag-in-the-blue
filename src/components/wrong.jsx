    ...
    <>
      ...
      {isCorrectOpen && (
        <div className="fixed inset-0 z-[60]"> 
          ...
          >
            <h2 className="text-4xl md:text-5xl font-extrabold uppercase tracking-widest text-red-500 mb-8"
            ...
            <div className="flex justify-center items-center mt-6">
              ...
              <button
                onClick={index === totalHints - 1 ? handleFinish : handleNextHintFromCorrect} 
                style={{ 
